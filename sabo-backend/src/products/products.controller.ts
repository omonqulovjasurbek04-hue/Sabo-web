...
export class ProductsController {
  ...
  @Public()
  @Get('products')
  @ApiOperation({ summary: 'Get paginated public products catalog with filters and translations' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Product detail with ingredients, nutrition and storage' })
