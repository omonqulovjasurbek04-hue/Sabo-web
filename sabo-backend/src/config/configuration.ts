export default () => ({
  ...
  jwt: {
    accessSecret: process.env.JWT_ACCESS_SECRET || 'dev_secret_access_key_min_32_chars_123',
    refreshSecret: process.env.JWT_REFRESH_SECRET || 'dev_secret_refresh_key_min_32_chars_123',
